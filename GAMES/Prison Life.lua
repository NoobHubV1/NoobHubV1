...
local function Goto(Player)
        plr.Character.HumanoidRootPart.CFrame = Player.Character.HumanoidRootPart.CFrame * CFrame.new(0, 0, 0)
end
...
PrisonLife:CreateButton("Arrest Plr", function()ArrestPlr()
end)
