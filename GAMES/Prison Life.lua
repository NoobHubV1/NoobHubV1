...
PrisonLife:CreateButton("Arrest Plr", function()LoadstringHttps("https://raw.githubusercontent.com/NoobHubV1/RobloxScripts/main/Prison%20Life%20Arrest%20Gui.lua")
end)
