...
BlackHole.BackgroundColor3 = Color3.fromRGB(172, 172, 172)
BlackHole.BackgroundTransparency = 0.500
BlackHole.BorderSizePixel = 0
BlackHole.Position = UDim2.new(0.0351677425, 0, 0.190713778, 0)
BlackHole.Size = UDim2.new(0, 131, 0, 40)
BlackHole.ZIndex = 3
BlackHole.Font = Enum.Font.SourceSansLight
BlackHole.Text = "Blackhole"
BlackHole.TextColor3 = Color3.fromRGB(255, 255, 255)
BlackHole.TextSize = 23.000

UICorner_19.CornerRadius = UDim.new(0, 4)
UICorner_19.Parent = BlackHole
...
local function DoCommand(Command)
	spawn(function()
		...
		elseif (string.sub(Command,1,#".blackhole") == ".blackhole") then
...
repeat
    for index, mover in pairs(movers) do
        mover.Position = charcframe:PointToWorldSpace(Vector3.new(math.random(0, 20), math.random(0, 20), math.random(0, 20)))
    end
    wait(0.5)
until LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0
for _, mover in pairs(movers) do
