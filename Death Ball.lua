([[
                This script has been licensed using Luarmor
                  Luarmor v3.7, Lua whitelisting system
                           https://luarmor.net/
