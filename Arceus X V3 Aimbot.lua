--[[
		...
		Remade and optimized by NoobHubV1 for Arceus X
		# spdmteam.com
		
		Edited and fixed by NoobHubV1 for Fluxus / Hydrogen Compatibility
        # NoobHubV1
]]
...
local toggleBtn
toggleBtn = addToggle("Toggle aimbot", function(Value)
	enabled = Value
end, false)

local toggleTeamCheckBtn
toggleTeamCheckBtn = addToggle("Team check", function(Value)
	teamcheck = Value
end)
