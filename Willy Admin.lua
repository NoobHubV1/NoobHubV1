...
local Versions = "v*1.0.2*support/yt @Willy639K"
local Cmd = {}

Cmd[#Cmd + 1] = {Text = "versions "..Versions,Title = "Script version:1.5 add : crouch"}
Cmd[#Cmd + 1] = {Text = "menu made by me willy",Title = "Script maker"}
