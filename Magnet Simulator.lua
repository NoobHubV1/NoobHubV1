...
MagnetSimulator:CreateDropdown("Auto Sell Area", {"Spawn","X2 Coin}, 2, function(Value)AutoSellArea = Value
end)

MagnetSimulator:CreateToggle("Auto Sell", function(State)getgenv().SellLoop = State
while SellLoop do
AutoSell(AutoSellArea)
task.wait()
end
end)
