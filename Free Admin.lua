...
Notify("NoobHubV1 Admin Abuser", "Anti Kick And Mute Loaded", 4)

task.wait(4)

Notify("NoobHubV1 Admin Abuser", "Type prefix(customcmds) to see custom commands", 4)
